...
import {registerNewEvents} from "../../../action/event-action-methods";
import { eventReducer } from "../../../reducer/event-reducer";

class RegisterNewEvents extends Component {
    ...
    onEventSubmit(e) {
        ...
        console.log(this.state);
         this.props.registerNewEvent(this.state);
    }
...
export default connect(mapStatetoProps, { registerNewEvent })(RegisterNewEvents);